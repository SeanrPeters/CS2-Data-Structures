...
public:
    ...
    int     length        ()                        const;  //Actual number of chars in stri$
    ...
    bool    operator<     (const String&)           const;
    String  substr        (int, int)                const;  //sub from staring to ending pos$
    int     findch        (int,  char)              const;  //Location of charater starting $
    int     findstr       (int,  const String&)     const;  //Location of string starting at$
